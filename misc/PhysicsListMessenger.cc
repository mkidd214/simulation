...
:pPhysicsList(pPhys)
{
  N06Dir = new G4UIdirectory("/code/");
  N06Dir->SetGuidance("UI commands of this example");
  
  physDir = new G4UIdirectory("/code/phys/");
  physDir->SetGuidance("PhysicsList control");
 
  verboseCmd = new G4UIcmdWithAnInteger("/code/phys/verbose",this);  
  ...
  cerenkovCmd = new G4UIcmdWithAnInteger("/code/phys/cerenkovMaxPhotons",this);  
